...
ARG MODULE_NAME="cr-azurerm_mysql_database"

# Declare default build configurations for terraform.
ARG BUILD_ARM_SUBSCRIPTION_ID="00000000-0000-0000-0000-000000000000"
ARG BUILD_ARM_CLIENT_ID=""
ARG BUILD_ARM_CLIENT_SECRET=""
ARG BUILD_ARM_TENANT_ID="00000000-0000-0000-0000-000000000000"
ARG BUILD_ARM_TEST_LOCATION="southcentralus"
